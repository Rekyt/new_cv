...
\textbf{Master Intern}\hfill{\footnotesize Indiana University}\newline
  ...
  \vspace{0.1cm}\begin{minipage}{0.7\textwidth}%
\begin{itemize}%
\item Supervised by \textbf{Dr. Jean-François Goût} in Michael Lynch's lab on trait motifs in the *Paramecium* complex%
\end{itemize}%
\end{minipage}%
\vspace{\parsep}}\\
\end{longtable}
...
{[}Data set{]}. \emph{Methods Blog}. Retrieved from
...
rOpenSci Community Calls {[}Data set{]}. \emph{rOpenSci Blog}. Retrieved
from \url{https://ropensci.org/blog/2020/07/15/subtitles/}

\leavevmode\hypertarget{ref-Grenie_Access_2019}{}%
3. \textbf{Grenié, M.}, \& Gruson, H. (2019). Access Publisher Copyright
\& Self-Archiving Policies via the 'SHERPA/RoMEO' API {[}Data set{]}.
\emph{rOpenSci Blog}. Retrieved from
