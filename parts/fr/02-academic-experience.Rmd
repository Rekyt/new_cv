...
tribble(
  ...
  "Thèse", "2016-2020", "Université de Montpellier", "Montpellier, France", "Directeurs: François Munoz et Cyrille Violle. Contrat doctoral spécifique normalien. Sur la rareté fonctionnelle et l'écologie fonctionnelle des communautés",
  ...
  "Encadrants: \\textbf{Dr. Éric Bapteste} et \\textbf{Prof. Philippe Lopez} sur les relations de réseaux de similarités de séquences en fonction de l'origine évolutive des voies métaboliques"
) %>% 
