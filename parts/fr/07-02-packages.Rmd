...
tibble::tribble(
  ...
  "funrar", "2016-présent", "R", "auteur principal et mainteneur", "calcul d'indices de rareté fonctionnelle, central pour les travaux du groupe CESAB FREE", c(paper = "https://doi.org/10.1111/ddi.12629", cran = "https://cran.r-project.org/package=funrar", github = "https://github.com/Rekyt/funrar")
) %>%
  rowwise() %>% 
  mutate(
