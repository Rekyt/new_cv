...
Summary of contributions. Number of publications. Citation. H-index (even if I despise it...)
...
paste_links = function(x) {
  ...
  if ("paper" %in% available_links) {
    final = append(
      final,
      paste0("\\faNewspaper\\,[published paper](", x[["paper"]],")")
    )
  }
...
\hfill\break \faNewspaper \ [published paper](https://doi.org/10.1111/ddi.12629), \faRProject \ [CRAN](https://cran.r-project.org/package=funrar), \faGithub \ [GitHub](https://github.com/Rekyt/funrar)
* **`ecolottery`** (co-creator)
\hfill\break simulates community assembly processes cleverly with both niche and neutral processes
\hfill\break \faNewspaper \ [published paper](https://doi.org/10.1111/2041-210X.12918), \faRProject \ [CRAN](https://cran.r-project.org/package=ecolottery), \faGithub \ [GitHub](https://github.com/frmunoz/ecolottery)
