...
```{r child-contributions, child="parts/en/07-00-contributions.Rmd"}
```

\newpage

```{r child-teaching, child="parts/en/08-teaching.Rmd"}
```

```{r child-skills, child="parts/en/09-skills.Rmd"}
```
